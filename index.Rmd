...
|             | *Break*                                         |    
| 13.00-15.30 | Statistical modeling (B)                        |
| *Wednesday* |                                                 |
| 09.00-12.00 | Data Validation and Editing (C)                 |
|             | *Break*                                         |             
| 13.00-15.30 | Imputation (D)                                  |
| *Thursday*  |                                                 |
| 09.00-12.00 | Workshop - bring your own data (E)              |
|             | *Break*                                         |
...
- Part C: Data Validation and Editing
    ...
    - [Practical C with solutions](Contents/Material/Part C - Data validation/Practical_C_walkthrough.html){target="_blank"}
    - [Practical C](Contents/Material/Part C - Data validation/Practical_C.html){target="_blank"}
...
- Part D: Imputation
    ...
    - [Practical D with solutions](Contents/Material/Part D - Imputation/Practical_D_walkthrough.html){target="_blank"}
    - [Practical D](Contents/Material/Part D - Imputation/Practical_D.html){target="_blank"}
