...
- Part A: Repetition
    ...
    - [Lecture1 - Tidy data](Part A - Repetition/Tidy_data.html){target="_blank"}
...
- Part B: Statistical Modeling
    ...
    - [Lecture B](Part B - modeling/Lecture_B.html){target="_blank"}
    - [Practical B](Part B - modeling/Practical_B.html){target="_blank"}
    - [Practical B with solutions](Part B - modeling/Practical_B_walkthrough.html){target="_blank"}
